...
class ReturnType extends AbstractType
{
    ...
    public function __construct(RequestStack $requestStack, ManagerRegistry $doctrine,ReturnsRepository $returnsRepository,MailerInterface $mailer, SluggerInterface $slugger, ParameterBagInterface $params) {
