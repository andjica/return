...
class ReturnController extends AbstractController
{
    ...
    public function createreturn(ManagerRegistry $doctrine,Request $request, int $id, SluggerInterface $slugger)
    {
        ...
        $item = $doctrine->getRepository(ResellerShipmentItems::class)->findOneBy(['id' => $itemsId]);
        ...
        $clientcountry = $client->getCountryId();
    ...
    public function editreturn(int $id, ManagerRegistry $doctrine)
    {
        ...
        if($itemsId)
        {
            $items = $doctrine->getRepository(ResellerShipmentItems::class)->findOneBy(['id'=> $itemsId]);
